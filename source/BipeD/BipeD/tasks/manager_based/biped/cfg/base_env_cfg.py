...
class ObservationsCfg:
    ...
    class PolicyCfg(ObsGroup):
        ...
        # heights scan
        heights: ObsTerm = MISSING # type: ignore
...
class RewardsCfg:
    ...
    rew_no_fly = RewTerm(
        ...
        weight=1.0,
        params={
            "sensor_cfg": SceneEntityCfg("contact_forces", body_names=["L4_Link_ankle", "R4_Link_ankle"]),
            "threshold": 5.0,
        },
    )
    ...
    pen_undesired_contacts = RewTerm(
        ...
        weight=-0.5,
        params={
            "sensor_cfg": SceneEntityCfg("contact_forces", body_names=["L[0-9]*_Link", "R[0-9]*_Link", "base_link"]),
            "threshold": 10.0,
        },
    )
    ...
    test_gait_reward = RewTerm(
        ...
        params={
            ...
            "sensor_cfg": SceneEntityCfg("contact_forces", body_names=[".*[LR]4.*ankle.*"]),
            "asset_cfg": SceneEntityCfg("robot", body_names=[".*[LR]4.*ankle.*"]),
        },
    )
